...
# `r emo::ji("tropical_fish")`  `r emo::ji("fish")` Crossing the Southern Polar Front `r emo::ji("fish")` `r emo::ji("tropical_fish")`    

Projet sur la campagne antarctique durant la formation "bonnes pratiques pour une recherche reproductible en écologie numérique" organisée par le Cesab `r emo::ji("earth_africa")`  `r emo::ji("earth_asia")`  `r emo::ji("tropical_fish")`.
